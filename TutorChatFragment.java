...
import com.paneapple.paneapple.adapters.TutorChatAdapter;
...
public class TutorChatFragment extends Fragment {
    ...
    private ArrayList<StudentChatList> tutors;
    private RecyclerView rv_tutors;
    private TutorChatAdapter tutorsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_student_chat_fragment, container, false);
    ...
    private void initview(View view) {
        ...
        databaseReference_chatlist = firebaseDatabase.getReference("Chatlist");
        ...
        tutorsAdapter = new TutorChatAdapter(tutors, getActivity());
    ...
    private void filterdata(String query) {
        ArrayList<StudentChatList> filter_tutors = new ArrayList<>();
        for (StudentChatList tutor : tutors) {
            if (tutor.getStudent_name().toLowerCase().contains(query.toLowerCase())) {
    ...
    private void getTutors() {
        ...
        databaseReference_chatlist.child(firebaseAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                pb_prgress_bar.setVisibility(View.GONE);
                Log.e("tutors", dataSnapshot + "");
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    StudentChatList StudentChatList = snapshot.getValue(StudentChatList.class);
                    tutors.add(StudentChatList);
                }
